...
using nickeltin.Localization.Utilities;
...
namespace nickeltin.Localization.Editor
{
    public class LocalizationWindow : EditorWindow
    {
        ...
        private void CreateLocalizedAssetPopup(Vector2 mousePosition)
        {
            ...
            EditorUtility.DisplayPopupMenu(popupPosition, "Assets/Create/Localization/", null);
        }
        ...
        {
            m_Translator = new GoogleTranslator(LocalizationManager.GoogleAuthenticationFile);
