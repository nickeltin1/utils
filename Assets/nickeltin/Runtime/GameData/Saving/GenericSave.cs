...
namespace nickeltin.Runtime.GameData.Saving
{
    ...
    /// By default can store arrays of: <see cref="float"/>, <see cref="int"/>, <see cref="string"/>, <see cref="bool"/>
    /// which can be assigned in inspector.
    /// Also, if it provided inside <see cref="MonoSave"/>, it will hold its data.
    ...
    public sealed class GenericSave : Saveable<object[]>
    {
        ...
        [SerializeField] private Entry<float>[] _floats;
        [SerializeField] private Entry<int>[] _ints;
        ...
        public bool SetFloat(float f, int id) => TryToSetArrayValue(_floats, f, id);
        public bool SetInt(int i, int id) => TryToSetArrayValue(_ints, i, id);
        ...
        public float GetFloat(int id) => _floats[id].value;
        public int GetInt(int id) => _ints[id].value;
        ...
        public int Length
        {
            ...
            get => 1 + 1 + _floats.Length + _ints.Length + _strings.Length + _bools.Length + _objects.Length + 
        ...
        public override void LoadDefault()
        {
            ...
            LoadDefaultToArray(_floats);
            LoadDefaultToArray(_ints);
        ...
        protected override void Deserialize(SaveSystem saveSystem, object[] obj)
        {
            ...
            DeserializeArray(obj, _floats, startingIndex, out startingIndex);
            DeserializeArray(obj, _ints, startingIndex, out startingIndex);
        ...
        protected override object[] Serialize()
        {
            ...
            SerializeArray(_floats, obj, startingIndex, out startingIndex);
            SerializeArray(_ints, obj, startingIndex, out startingIndex);
